...
<script>
   ...
   function resetWorkingTargetSet(){
    ...
    <div class="crowdluvsection"> 
        <h1>Message Followers - <?php echo $clRequestInformation->getActiveManagedBrand()['fb_page_name'];?><img style="display:inline-block;width:2%;" src='https://graph.facebook.com/<?php echo $clRequestInformation->getActiveManagedBrand()['fb_pid']; ?>/picture?access_token=<?php echo $facebookSession->getToken();?>'></h1>
        <br> 
    </div>
