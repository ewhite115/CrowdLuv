...
$talentFacebookPermissionScope = array(
  ...
  $talentFacebookLoginHelper = new FacebookRedirectLoginHelper(CLADDR . "test-facebook-after.php");
  $talentLoginURL = $talentFacebookLoginHelper->getLoginUrl($talentFacebookPermissionScope);
...
<body>
    ...
    <a href="<?php echo $followerLoginURL;?>"><img width="60%" class=" " src="<?php echo BASE_URL;?>res/signin-facebook.jpg" /> </a>
