...
*/
	...
	define('QA_MYSQL_HOSTNAME', $_SERVER['CL_DB_HOSTNAME']); // try '127.0.0.1' or 'localhost' if MySQL on same server
	define('QA_MYSQL_USERNAME', 'crowdluv');
	define('QA_MYSQL_PASSWORD', 'crowdluv');
	define('QA_MYSQL_DATABASE', 'crowdluv');
