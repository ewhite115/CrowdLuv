 ...
 ?>
    ...
    <div class="crowdluv_landingpage_memberlogin_box" id="crowdluv_landingpage_memberlogin_notloggedin">
        ...
        if(! $fb_user) {
            ...
            //echo '<a href="https://www.facebook.com/dialog/oauth?client_id=' . FB_APP_ID . '&redirect_uri=' . CLADDR . '">alt login </a>'; 
            ...
            //echo "<fb:login-button show-faces=\"false\" width=\"300\" max-rows=\"1\"></fb:login-button>";
             ...
             echo "Welcome back to CrowdLuv, " . $CL_LOGGEDIN_USER_OBJ['firstname'] . "!<br>"; 
             echo '<br> <img src="https://graph.facebook.com/'. $fb_user . '/picture?access_token=' . $facebook->getAccessToken() . '"><br><br>';
             echo "You have Luv'ed <a href='followerdashboard.php'>" . count(get_talents_for_follower($CL_LOGGEDIN_USER_UID)) . " of your favorite talent</a>";
            }
       ...
       <?php 
        if ( (! $fb_user) || (!$fb_user_pages)){  //not logged into facebook, or logged in but dont have manage_page permissions
            ...
            foreach($CL_LOGGEDIN_TALENTS_ARR as $cltalentobj){
                ...
                echo '<br><a href="talentdashboard.php?crowdluv_tid=' . $cltalentobj['crowdluv_tid'] . '">';    
