...
class FacebookRedirectLoginHelper
{
  ...
  public function getSessionFromRedirect()
  {
    ...
    if ($this->isValidRedirect()) {
      //echo "**isvalidredirect returned true";
      $params = array(
  ...
  protected function isValidRedirect()
  {
    ...
    //$stmatch = isset($_GET['state']) && $_GET['state'] == $this->state;
    //echo "<br>this-state: " . $this->state;
    //echo "<br>get[state]: " . $_GET['state'] . "<BR>";
    //echo "<br>state matches?: " . $stmtch . "<br>";
    $ret = $this->getCode() && isset($_GET['state']) ;//&& $_GET['state'] == $this->state;
    //echo "isValidRedirect():" . $ret  . "<br>";
    return $ret;
  ...
  {
    $ret = isset($_GET['code']) ? $_GET['code'] : null;
    //echo "getCode():" . $ret . "<br>";
    return $ret;
