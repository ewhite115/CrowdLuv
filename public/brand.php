   ...
   <div class="row   crowdluvsection <?php if($profileSubPage != "main") echo "hidden-xs"; ?>">        
    ...
    <div class="row">      
       <div class="col-xs-12 col-sm-10 col-sm-offset-1 clwhitebg crowdluvsection text-center">
            ...
            <img class="img-responsive center-block" src="https://graph.facebook.com/<?php echo $clRequestInformation->getTargetBrand()["fb_pid"];?>/picture?type=large<?php if(isset($CL_LOGGEDIN_USER_UID)){ ?>&access_token=<?php echo $clFacebookHelper->getFacebookSession()->getToken(); }?>">             
            </a>
                        ...
                        <?php foreach($talentQuestionList as &$talentQuestion){ ?>
                            ...
                            <div class='cl-ticker-item-block' onClick="javascript:window.location.href = window.location.href + '&p=questions&questionid=<?= $talentQuestion['postid']; ?>'">
                                <div class='cl-ticker-question-score inline-block'>
                                    <img style="width:2em" src="https://graph.facebook.com/<?= $talentQuestion['submitterInfo']['fb_uid'];?>/picture?type=square<?php if(isset($CL_LOGGEDIN_USER_UID)) { ?>&access_token=<?php echo $clFacebookHelper->getFacebookSession()->getToken();}?>"> 
                ...
                <div id="myTabContent" class="tab-content">
                    <div class="tab-pane fade in active cl-panel-vscroll cl-panel-tall-height" id="home">
                        ...
                        <?php $i=0; foreach($rankedLuvers as $rankedLuver) { ?>
                            <p>
                                <img src="https://graph.facebook.com/<?php echo $rankedLuver['fb_uid'];?>/picture?type=square<?php if(isset($CL_LOGGEDIN_USER_UID)) { ?>&access_token=<?php echo $clFacebookHelper->getFacebookSession()->getToken();}?>"> 
