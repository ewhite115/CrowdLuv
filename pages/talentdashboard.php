...
?>
    ...
    <div class="crowdluvsection">
        ...
        <img src='https://graph.facebook.com/<?php echo $clRequestInformation->getActiveManagedBrand()['fb_pid']; ?>/picture?access_token=<?php echo $clFacebookHelper->getFacebookAccessToken();?>'><br>
        <br>
    ...
    <div class="crowdluvsection">
         ...
         <?php foreach ($folst as $folt) { ?>               
                <img src="https://graph.facebook.com/<?php echo $folt['fb_uid'];?>/picture?access_token=<?php echo $clFacebookHelper->getFacebookAccessToken();?>"> 
         <?php } //var_dump($folst); ?> 
    </div>
