<?php
	...
	require_once(ROOT_PATH . "inc/cl_bootstrap.php");
...
*/
	...
	//	Until you edit this function, don't show login, register or logout links
		...
		return array(
			'login' => $_SERVER['CL_BASE_URL'],
			'register' => $_SERVER['CL_BASE_URL'],
			'logout' => null
		);
...
*/
	...
	//	Until you edit this function, nobody is ever logged in
		...
		if(!isset($_SESSION["CL_LOGGEDIN_USER_UID"])) return null;
		$level = QA_USER_LEVEL_BASIC;
		if($_SESSION["CL_LOGGEDIN_USER_UID"] == 1) $level = QA_USER_LEVEL_SUPER;
