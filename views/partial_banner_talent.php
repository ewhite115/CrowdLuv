	...
	<div class="header cl_site_section_header">
		...
		<ul id="cl_nav" class="nav nav-pills ">
	      ...
	      <li class="text-center"><img style="width:70%;"  src='https://graph.facebook.com/<?php echo $clRequestInformation->getActiveManagedBrand()['fb_pid']; ?>/picture?access_token=<?php echo $clFacebookHelper->getFacebookAccessToken();?>'></li>
